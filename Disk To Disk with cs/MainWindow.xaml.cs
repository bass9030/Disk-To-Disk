    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)//wpf가 로드됐다면
        {
            try
            {
                ...
                System.Windows.Forms.MenuItem nowback = new System.Windows.Forms.MenuItem();
                ...
                menu.MenuItems.Add(nowback);
                nowback.Index = 1;
                nowback.Text = "변경된 파일 바로 백업하기";
                nowback.Click += delegate (object click, EventArgs eClick)//show클릭시 실행할 명령
                {
